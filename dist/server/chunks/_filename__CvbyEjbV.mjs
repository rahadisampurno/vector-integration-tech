...
//#region src/pages/api/download/license/[filename].ts
var _filename__exports = /* @__PURE__ */ __exportAll({ GET: () => GET });
...
//#endregion
//#region \0virtual:astro:page:src/pages/api/download/license/[filename]@_@ts
