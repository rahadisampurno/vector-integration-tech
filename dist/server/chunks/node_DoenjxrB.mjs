...
import { a as fetchWithRedirects, c as resolveDefaultOutputFormat, d as resolveSrc, f as DEFAULT_HASH_PROPS, i as inferRemoteSize$1, l as isESMImportedImage, n as isLocalService, s as inferSourceFormat, u as isRemoteImage } from "./service_CT8kbHX_.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp__bMWWZVB.mjs").catch((e) => {
